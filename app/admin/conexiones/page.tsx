...
type Conexion = { id: number; nombre: string; url: string; fechaCreacion: string; ultimaSincronizacion: string | null; fechaBaja: string | null; cantidadCarreras: number }
